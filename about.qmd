---
title: "About Me" # title of page and what shoes in navbar
subtitle: "What Makes Me Happy" # subtitle
title-block-banner: true # title will assume this format
toc: false # no table of contents
format:
  html:
    code-fold: false # don't show code for interactive graphic on website, only show output
    echo: false
    warning: false
    message: false
---
...
library(leaflet) # use leaflet package

visited_places <- data.frame( # inputting data frame directly into R studio
  place = c( # list places
  ...
  lng = c( # listing on longitudes of places
  ...
  lat = c( # listing all latitudes of places
...
m <- leaflet() %>% # map will be called m, from leaflet package
  addTiles() %>% # the information related to the pins
  setView(lng = 0, lat = 20, zoom = 2) # where the initial visual on the graphic is located

# Add clickable pins with popups
m <- m %>% addMarkers( # add pins to the maps
  lng = visited_places$lng, # pins are based on listed latitude and longitude
  lat = visited_places$lat,
  popup = paste0("I visited <b>", visited_places$place, "</b>!") # message included in popup
)
...
![Sziget, Budapest](sziget.jpg){width="188"} ![Reading, London](reading.jpg){width="106"} ![Dom Dolla](domdolla.jpg){width="115" height="140"} ![Excision](concert.jpeg){width="159" height="194"} ![Lightening in a Bottle](lib.jpg){width="146"} ![Outsidelands](osl.jpg){width="147"}
...
![Friends](friends1.jpeg){width="194"} ![liv](liv.jpg){width="114"} ![dessert](dessert.jpg){width="115"}![cowgirl](cowgirl.jpeg){width="175"} ![cr](cr.jpg){width="99"} ![hawaii](hawaii.jpeg){width="177"}
